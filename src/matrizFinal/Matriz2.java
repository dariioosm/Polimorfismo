...
public class Matriz2 {
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("3.Suma de columna elegida por usuario");
    ...
    public static void rellenaMatrizTeclado(int[][] matriz) {
        Scanner in = new Scanner(System.in);
    ...
    public static double promedioMatriz(int[][] matriz) {
        ...
        promedio = suma / (double) (matriz.length * matriz[0].length);
        return promedio;
    }
}
