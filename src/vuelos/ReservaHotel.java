...
public class ReservaHotel extends Reserva {
	...
	public ReservaHotel(String nombreCliente, int numeroDias, double precioBase, int numeroPersonas, 
			String nombreHotel, String ubicacionHotel) {
	...
	public String toString() {
		return "ReservaHotel [nombreCliente= " + getNombreCliente() + ", numeroDias= " + getNumeroDias() + ", precioBase= " + 
				getPrecioBase() + ", numeroPersonas= " + getNumeroPersonas() + "nombreHotel=" + nombreHotel + 
				", ubicacionHotel=" + ubicacionHotel + "]";
	}
