...
public class Hospitalario extends Sanitario implements Serializable{
	...
	public Hospitalario(String apellidoNombre, String numeroRegistro, int numeroTrienios, String grupo,String hospital) {
	...
	public double calculoNomina() {
		...
		for(int i=0;i<prima.length;i++) {
			if(prima[i].equals(numeroTrienios)) {
				nomina=dinero[i]*nomina;
